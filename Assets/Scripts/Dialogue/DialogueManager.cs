...
public class DialogueManager : MonoBehaviour, IDataPersistence
{
    ...
    private OpenCloseWindow openCloseWindow;
    ...
    private void Start() 
    {
        ...
        openCloseWindow = GameObject.Find("Canvas - Overlay - Dialogue").GetComponent<OpenCloseWindow>();
    ...
    public void EnterDialogueMode(TextAsset inkJSON, Animator emoteAnimator, Quest quest) 
    {
        ...
        inkExternalFunctions.Bind(currentStory, emoteAnimator, quest);
    ...
    */
    ...
    {
       dialogueVariables.SetVariableBool(variableName, value);
    }

    public void LoadData(GameData data)
    {
        // now we can create a new DialogueVariables object that's being initilized based on any loaded data
